...
var makeContent = function (image) {
  return {
    "16": data.url(image),
    "32": data.url(image.replace(".png", "@2x.png"))
  }
};
...
var snoozePanel = Panel({
  ...
  onShow: function () {
    widget.icon = makeContent('SnoozeTabsButton.png');
  },
  onHide: function () {
    widget.icon = makeContent('SnoozeTabsButtonGrey.png');
...
var widget = ToggleButton({
  id: 'snoozetabs-btn',
  label: 'Snooze',
  icon: makeContent('SnoozeTabsButtonGrey.png'),
